...
const SECONDARY_NAV_ICON_SIZE: int = 32
const SECONDARY_NAV_LABEL_SIZE_ACTIVE: int = 13
const SECONDARY_NAV_LABEL_SIZE_INACTIVE: int = 12
const SECONDARY_NAV_INACTIVE_ALPHA: float = 0.58
const QUIZ_FAB_SIZE: float = 92.0
const QUIZ_FAB_LIFT: float = 26.0
const QUIZ_FAB_ICON_SIZE: int = 46
const QUIZ_FAB_LABEL_SIZE: int = 15
