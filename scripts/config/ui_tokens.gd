...
const TOP_BAR_BG := ACCENT_QUIZ_DEEP                            # source unique de la couleur de la top bar (#2E8FE0)
const HEADER_BANNER_FG := TEXT_ON_ACCENT
const HEADER_BANNER_HEIGHT: float = 88.0
const HEADER_SHELL_HEIGHT: float = 88.0
...
const BOTTOM_NAV_HEIGHT: float = 88.0
const BOTTOM_NAV_TOTAL_HEIGHT: float = 164.0
...
const QUIZ_FAB_LIFT: float = 48.0
